...
import { FaBuilding, FaTrain, FaTicketAlt, FaBus, FaCalendarAlt, FaStar, FaChair, FaUserFriends, FaMapMarkerAlt, FaChevronDown } from "react-icons/fa";
...
const BookingHistoryPage: React.FC = () => {
  ...
  const filteredBookings = activeTab === "Semua" ? bookings : bookings.filter((b) => b.category === activeTab);
                    ...
                    <div key={booking.id} className="booking-card">
                      ...
                      <div className="booking-info">
                        <div className="info-header">
                          ...
                          <span className={`status-badge ${booking.status === "Selesai" ? "badge-green" : "badge-yellow"}`}>{booking.status}</span>
                        </div>
